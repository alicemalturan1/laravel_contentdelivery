...
<head>
    ...
    <meta charset="utf-8" />
    <title>Alt Menü Linki Oluştur | Panel</title>
    ...
    <!-- ============================================================== -->
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                @include('admin.section.page_header',['title'=>'Alt Menü Linki Oluştur'])
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row justify-content-between">
                                    <div class="col-lg-4">
                                        <h4 class="card-title mb-4">Alt Menü Linki Oluşturma formu</h4>
                                    </div>
                                        ...
                                        <div data-repeater-item class="outer">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="mb-3 col-lg-10">
                                                    <input data-toggle="touchspin" type="text" value="{{count(\App\Models\FooterMenuItems::all())}}">
                                                </div>
                                            </div>
                                            <div class="row ">
                                                <div class="pt-1 pb-1">
                                                <div style="padding-right: 0;" class="row  justify-content-end">
                                                    <div  style="padding-right: 0;" class="col-lg-10">
                                                        <div class="alert alert-warning text-center alert-dismissible fade pr-0 show mb-0" role="alert">
                                                            <i class="mdi mdi-alert-circle-outline me-2"></i>  Toplamda <b>{{count(\App\Models\FooterMenuItems::all())}}</b> adet link bulunmaktadır.
