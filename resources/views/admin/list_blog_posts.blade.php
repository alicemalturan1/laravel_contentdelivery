    ...
    <!-- ============================================================== -->
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                @include('admin.section.page_header',['title'=>'Blog İçerikleri'])
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row justify-content-between">
                                    <div class="col-lg-4">
                                        <h4 class="card-title mb-4">Blog İçeriklerini listele</h4>
                                    </div>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    @foreach( \App\Models\BlogPost::all() as $item)
                                        <tr>
                                            ...
                                            <td>{{\App\Models\User::where('id',$item->author_id)->first()->name." ".\App\Models\User::where('id',$item->author_id)->first()->surname}} ({{$item->author_id}})</td>
                                            <td>
